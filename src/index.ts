...
const s1Submit = document.getElementById("s1Btn") as HTMLButtonElement;
const s1Results = document.querySelector(".s1Results") as HTMLElement;
const s1Input = document.getElementById("s1Input") as HTMLInputElement;

const s1Nums = (event: Event): void => {
...
const s2Submit = document.getElementById("s2Btn") as HTMLButtonElement;
const s2Results = document.querySelector(".s2Results") as HTMLElement;
const s2Input = document.getElementById("s2Input") as HTMLInputElement;

const s2Nums = (event: Event): void => {
  event.preventDefault();
...
const s3Submit = document.getElementById("s3Btn") as HTMLButtonElement;
const s3Results = document.querySelector(".s3Results") as HTMLElement;
const s3Input = document.getElementById("s3Input") as HTMLInputElement;

const s3Vowels = (event: Event): void => {
  event.preventDefault();
...
const s4Submit = document.getElementById("s4Btn") as HTMLButtonElement;
const s4Results = document.querySelector(".s4Results") as HTMLElement;
const s4Input = document.getElementById("s4Input") as HTMLInputElement;

const s4String = (event: Event): void => {
  event.preventDefault();
